import { getAllPostIds, getPostData } from '../../lib/posts-c1'
...
export async function getStaticPaths() {
      ...
      <div className="flex place-content-center m-4">
          ...
          <div className="md:w-1/2 w-full ml-10">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="block w-5 h-5 text-gray-400 mb-4" viewBox="0 0 975.036 975.036">
                  ...
                  <h1 className='text-3xl text-black'>{route[2].toUpperCase() + ' ' + route[3]}</h1>
          ...
          <div className="md:w-1/2 w-full ml-10">
              ...
              <CodeEditor showCongrats={setShowCongrats} course={currCourse} chapter={currChapter} lang="typescript" value={postData.value} expectedValue={postData.expectedValue}/>
          </div>
                  ...
                  <div className="relative px-4 w-full max-w-2xl h-full md:h-auto m-auto">
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                      ...
                      <div className="grid items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                          <button onClick={() => router.push(nextRoute)} className="text-white bg-gray-500 py-2 px-20 focus:outline-none hover:bg-gray-700 rounded text-lg">
                            Next Course
                          </button>
                      </div>
                    </div>
  ...
  <div className=" mt-10 bg-bg-footer bg-no-repeat bg-cover bg-bottom h-32"/>
    <Footer/>
